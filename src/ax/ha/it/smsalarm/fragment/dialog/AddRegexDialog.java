...
/**
 * {@link DialogFragment} which let's the user add a <b><i>Regular Expression</i></b> to the list of <b><i>Primary or Secondary Alarm Trigger Regular
 * Expressions</i></b>, this depends on which <b><i>RequestCode</i></b> this <code>AddRegexDialog</code> is set to.
 *
 ...
 * @see #ADD_REGEX
 * @see #ADD_REGEX_DIALOG_TAG
 * @see #ADD_PRIMARY_REGEX_DIALOG_REQUEST_CODE
 * @see #ADD_SECONDARY_REGEX_DIALOG_REQUEST_CODE
 */
public class AddRegexDialog extends DialogFragment {
	private static final String LOG_TAG = AddRegexDialog.class.getSimpleName();

	// Used as a key when putting data into bundles and intents, dialog tag can come in handy for classes using this dialog
	public static final String ADD_REGEX = "addRegex";
	public static final String ADD_REGEX_DIALOG_TAG = "addRegexDialog";

	// Request codes used for this dialog
	public static final int ADD_PRIMARY_REGEX_DIALOG_REQUEST_CODE = 26;
	public static final int ADD_SECONDARY_REGEX_DIALOG_REQUEST_CODE = 27;
	...
	/**
	 * To create a new instance of {@link AddRegexDialog}.
	 */
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			if (savedInstanceState.getCharSequence(ADD_REGEX) != null) {
				inputEditText.setText(savedInstanceState.getCharSequence(ADD_REGEX).toString());
			}
		}
		...
		switch (getTargetRequestCode()) {
			case (ADD_PRIMARY_REGEX_DIALOG_REQUEST_CODE):
				message = getString(R.string.ADD_PRIMARY_REGEX_DIALOG_MESSAGE);
				break;
			case (ADD_SECONDARY_REGEX_DIALOG_REQUEST_CODE):
				message = getString(R.string.ADD_SECONDARY_REGEX_DIALOG_MESSAGE);
				break;
			default:
		...
		return new AlertDialog.Builder(context)
				...
				.setTitle(R.string.ADD_REGEX_DIALOG_TITLE)	// Set title
				...
				.setPositiveButton(R.string.OK, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int whichButton) {
						...
						intent.putExtra(ADD_REGEX, inputEditText.getText().toString());
	...
	public void onSaveInstanceState(Bundle arg0) {
		...
		arg0.putCharSequence(ADD_REGEX, inputEditText.getText().toString());
	}
}
