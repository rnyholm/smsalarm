 ...
 * {@link Fragment} is only showing a log of {@link AlarmLogItem}'s which contains {@link Alarm}'s of {@link AlarmType#SECONDARY}.
 * 
...
public class SecondaryAlarmLogFragment extends AlarmLogFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		createAlarmLogItems(adapter, EnumSet.<AlarmType> of(AlarmType.SECONDARY));
